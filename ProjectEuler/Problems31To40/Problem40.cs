...
public static class Problem40
{
    ...
    {
        return int.Parse(sDigits[index].ToString());
    }
    ...
    public static long Answer()
    {
        ...
        return GetDigit(sbDigits, 1)
            * GetDigit(sbDigits, 10)
            * GetDigit(sbDigits, 100)
            * GetDigit(sbDigits, 1000)
            * GetDigit(sbDigits, 10000)
            * GetDigit(sbDigits, 100000)
